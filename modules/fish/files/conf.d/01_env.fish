# SSH agent - initialize once per terminal (not in tmux)
if [ -z $TMUX ]
    init-ssh-agent
end

#set -gx CLAUDE_CODE_OAUTH_TOKEN sk-ant-oat01-ygukgxRP_NbPMLfhZsESmFaBreA_1MxHBsR1XwokySPDHfQ_QxhtW-jjxl0j7EX2KevzYBMyg3VzdxqsSYOTSA-_-OnQQAA
